...
Cross-File Associations (CFAs) are a way to declare relationships among files and file-like objects. They help software and humans to be smarter about grouping things together. Their theory is explained in an [academic paper](https://dhh1128.github.io/papers/cfa_paper.html). Here, you can find a specification/developer documentation.
